---
description: Audit the live HA instance against CONVENTIONS.md/GOTCHAS.md and report findings
---

Audit the live Home Assistant instance against the conventions documented in `CONVENTIONS.md` (Naming Convention, Decision Rules, Icon Guidelines, Common Entity Patterns) and `GOTCHAS.md` (Hue Groups). This is read-only against the live instance — don't fix anything yet, just find and report.

## Steps

1. Read `CONVENTIONS.md` and `GOTCHAS.md` in full for the current conventions.
